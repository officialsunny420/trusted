					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="membership_amount" value="<?php echo set_value('membership_amount') ?>" id="membership_amount" autocomplete="off" />
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="commission_paid" value="<?php echo set_value('commission_paid') ?>" id="commission_paid" autocomplete="off" />
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="rental_income_for_partner" value="<?php echo set_value('rental_income_for_partner') ?>" id="rental_income_for_partner" autocomplete="off" readonly />
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="rental_income_for_admin" value="<?php echo set_value('rental_income_for_admin') ?>" id="rental_income_for_admin" autocomplete="off" readonly />
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="date" class="form-control" name="rented_on" value="<?php echo set_value('rented_on') ?>" id="rented_on" autocomplete="off" />
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="warehouse_arrival_date">Expiry Date<span class="favor_in_span">*</span></label>
								<input type="date" class="form-control" name="expiry_date" value="<?php echo set_value('expiry_date') ?>" id="expiry_date" autocomplete="off" />
						...
						<!--<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="rented_items" value="<?php echo set_value('rented_items') ?>" id="rented_items" autocomplete="off" />
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="number_of_rotations" value="<?php echo set_value('number_of_rotations') ?>" id="number_of_rotations" autocomplete="off" />
						...
						--->
						<input type="hidden" class="form-control" name="retail_value" value="" id="retail_value" autocomplete="off" />
