                    ...
                    <div class="row">
							...
							<div class="col-md-4 user_avatar">
								<div class="form-group">
									...
									<input type="hidden" name="avtar_file" class="file"  value="<?php if(!empty($media_id)) { echo $media_id;} ?>"/>
								...
								<?php if(isset($profile_pic_src)):?>
								<div class=" existing_user_avatar">
									<div class="form-group">
										<label>Profile Picture </label> 
										<img src="<?=$profile_pic_src ?>" alt="<?=$name ?>" width="100" height="100"> 
									</div>
								</div>
								<?php endif;?>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea class="form-control" name="description" id="exampleTextarea1" rows="4" autocomplete="off"><?=$description?></textarea>
								</div>
							</div>
                            ...
                            <div class="col-md-4">
								<div class="form-group">
									<label for="exampleInputEmail3">Chamber of commerce<span class="favor_in_span">*</span></label>
