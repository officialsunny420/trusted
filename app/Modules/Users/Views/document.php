        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
				   <div class="row">
						<div class="col-lg-6">
							<h4 class="card-title">Add Document of <?=$user_name?></h4>
						</div>
                   ...
                   <!-- <?php if (!empty($errors)) : ?>
					...
					<h4 class="card-title" >Document Details of <?=$user_name?></h4>
					<hr>
                                ...
                                <?php if($results): ?>
                                    <?php foreach($results as $result):
                                        ...
                                        <tr>
											...
											<td>
												<a class="delete_document" href="#" data-id="<?=$result['id']?>" data-url="<?php echo base_url('admin/'.$mr.'/delete_document') ?>" ><label class="badge badge-success"><i class="mdi mdi-delete"></i> Delete</label></a>
											</td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else: ?> 
